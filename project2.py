...
class CatchBallGame:
    def __init__(self, root):
        ...
        self.pause_button = tk.Button(self.game_frame, text="Pause", font=("Arial", 14),command=self.pause_resume_game)
        ...
        self.basket = self.canvas.create_rectangle(250, 360, 350, 380, fill="brown")
    ...
    def spawn_ball(self):
        ...
        ball = self.canvas.create_oval(x, 10, x+30, 40,fill=random.choice(["red", "orange", "green", "purple"]))
    ...
    def update_ball(self):
        ...
        for ball in self.ball:
            ...
            if ball_coords[3] >= basket_coords[1]:
    ...
    def end_game(self):
        ...
        tk.Button(self.end_frame, text="Play Again", font=("Arial", 18),command=self.start_game).pack(pady=10)
        tk.Button(self.end_frame, text="Quit", font=("Arial", 18),command=self.root.quit).pack()
